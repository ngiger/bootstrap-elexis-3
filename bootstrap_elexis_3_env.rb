...
REPOS = {
  'http://download.eclipse.org/releases/mars' => ['epp.package.rcp',
...
#  'http://repo1.maven.org/maven2/.m2e/connectors/m2eclipse-tycho/0.7.0/N/0.7.0.201309291400' => ['org.sonatype.tycho.m2e.feature.feature.group'],
  'http://download.eclipse.org/technology/m2e/releases/1.6/1.6.2.20150902-0002' => ['org.eclipse.m2e.feature.feature.group'],
...
#  'http://www.wdev91.com/update' =>['com.wdev91.eclipse.copyright'],
  ...
  'http://mbarbero.github.io/fr.obeo.releng.targetplatform/p2/latest/' => ['fr.obeo.releng.targetplatform-feature.feature.group'],
  }
