...
* Select Menu/Import... Select Maven/Existing maven repositories and browse to the checkout directory of your cloned bootstrap-elexis-3 repository. This will need some time to find all Elexis-3 projects. Click next, then finish and ignore the warning 
